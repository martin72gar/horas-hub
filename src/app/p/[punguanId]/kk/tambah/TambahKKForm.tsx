      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="space-y-1.5">
            ...
            <input required name="headName" className="w-full px-3 py-2 border border-stone-300 focus:ring-1 focus:ring-red-500 focus:border-red-500 rounded-md" placeholder="Contoh: Aman Sirait" />
          </div>
          <div className="space-y-1.5">
          ...
          <div key={i} className="flex flex-col md:flex-row gap-4 items-start md:items-center bg-stone-50 p-4 rounded-xl border border-stone-200">
            <div className="flex-1 space-y-1.5 w-full">
              ...
              <input 
                ...
                className="w-full px-3 py-2 text-sm border border-stone-300 focus:ring-1 focus:ring-red-500 focus:border-red-500 rounded-md" 
                placeholder="Nama Lengkap" 
                required={i === 0} // Make first row required for better UX if needed, or leave optional
              />
            </div>
